...
public class @XRIDefaultInputActions : IInputActionCollection, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Pause Game"",
                    ""type"": ""Button"",
                    ""id"": ""3288870e-a2ed-49ca-b553-4621103b2529"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""d90ec655-d5c1-4da1-98d1-dd6750c6813a"",
                ...
                {
                    ""name"": """",
                    ""id"": ""8df29500-28b0-418a-98e5-11976a9b1d99"",
                    ""path"": ""<OpenVROculusTouchController>{RightHand}/thumbstickClicked"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
                    ""action"": ""Pause Game"",
    ...
    ""controlSchemes"": [
        ...
        m_XRIRightHand_PauseGame = m_XRIRightHand.FindAction("Pause Game", throwIfNotFound: true);
    }
    ...
    public struct XRIRightHandActions
    {
        ...
        public void SetCallbacks(IXRIRightHandActions instance)
        {
            if (m_Wrapper.m_XRIRightHandActionsCallbackInterface != null)
            {
                ...
                @PauseGame.started -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnPauseGame;
                @PauseGame.performed -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnPauseGame;
                @PauseGame.canceled -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnPauseGame;
            }
